    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                MultiField(title: "Descripción", text: $descripcion, desc: "Ingresa una descripción...", lines: 4, focusedField: $focusedField, field: .descripcion, nextfield: .direccion)
                MultiField(title: "Dirección", text: $direccion, desc: "Ingresa una dirección...", lines: 3, focusedField: $focusedField, field: .direccion,  nextfield: .none).padding(.bottom)
